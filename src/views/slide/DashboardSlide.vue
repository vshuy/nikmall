                  ...
                  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                      <div class="position-sticky pt-3">
                          <ul class="nav flex-column">
                               <li class="nav-item">                                  
                                  <router-link class="nav-link active" to="/dashboardproduct">Manage product</router-link>
                              </li>
                              <li class="nav-item">
                                  <router-link class="nav-link active" to="/dashboardbill">Manage bill</router-link>
                              </li>
                               <li class="nav-item">                                  
                                  <router-link class="nav-link active" to="/dashboardslide">Manage slide</router-link>
                              </li>
                              <li class="nav-item">
                                  <router-link class="nav-link active" to="/dashboardcategory">Manage category</router-link>
                              </li>
                              <li class="nav-item">
                          ...
                          <table class="table table-striped table-sm">
                              ...
                              <tbody>
                                <tr v-for="(item, index) in slides" :key="index">
                                    <td>{{ item.id }}</td>
                                    <td>{{ item.title }}</td>
                                    <td><u v-on:click="deleteSlideById(item.id)">Xóa danh mục này</u></td>
                                </tr>
                              </tbody>
                          </table>
                      </div>
