                          ...
                          <table class="table table-striped table-sm">
                              ...
                              <tbody>
                                <tr v-for="(item, index) in categories" :key="index">
                                    ...
                                    <td>{{ item.descripe }}</td>
                                    <td> <router-link :to="{ name: 'updatecategory', params: { id: item.id } }"> Edit this category</router-link></td>
                                    <td><u v-on:click="deleteCategoryById(item.id)">Xóa danh mục này</u></td>
                                </tr>
                              </tbody>
                          </table>
                      </div>
