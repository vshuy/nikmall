<template>
  <div class="mt-0">
    ...
    <footer class="text-center text-lg-start bg-light text-muted">
        ...
        <div class="container text-center text-md-start mt-0">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4 mt-3">
              ...
              <p>
                <a href="#!" class="text-reset">Table</a>
              </p>
              <p>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 mt-3">
              ...
              <p><i class="fas fa-home me-3"></i> Thai Nguyen, TN 250000, VN</p>
              <p>
                <i class="fas fa-envelope me-3"></i>
                vshbmt@gmail.com
              </p>
              <p><i class="fas fa-phone me-3"></i> + 03 325 917 76</p>
            </div>
            <!-- Grid column -->
          </div>
          <!-- Grid row -->
      ...
      >
        © 2021 Copyright:
        <a class="text-reset fw-bold" href="https://niaws.cf/">NikShop</a>
      </div>
      <!-- Copyright -->
    </footer>
    <!-- Footer -->
